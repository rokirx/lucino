...
public class IndexWriter09
{
    public static void main( String[] args ) throws Exception
    {
        ...
        doc.add( new Field( "titel", "first", Field.Store.NO, Field.Index.NO_NORMS ));
        writer.addDocument( doc );

        doc = new Document();
        doc.add( new Field( "text", (new String("123Ö")).getBytes("ISO-8859-1"), Field.Store.YES ));
        doc.add( new Field( "titel", "second", Field.Store.NO, Field.Index.NO_NORMS ));
        writer.addDocument( doc );
